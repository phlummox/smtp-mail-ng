...
tlsClientParams :: Network.TLS.HostName -> CertificateStore -> ClientParams
...
data SMTPContext = SMTPContext {
  ...
  , smtpServerHostName :: Network.TLS.HostName
  , smtpClientHostName :: Network.TLS.HostName
  , smtpDebug :: String -> IO ()
...
getSMTPServerHostName :: SMTPContext -> Network.TLS.HostName
getSMTPServerHostName = smtpServerHostName

getSMTPClientHostName :: SMTPContext -> Network.TLS.HostName
